...
<html>
   ...
   <body>
      <div class="header">
         ...
         <p>Forget Password Form - Admin</p>
      </div>
      <div class="navbar">
         <a href="/ShuSeeYong/project/php/admin/loginad.php" class="left">Home</a>
      </div>
      <div class="main">
         <center>
         ...
         <div class="container">
            <form name="forgetForm" action="../admin/forget.php" onsubmit="return validateForgetForm()" method="post">
               <div class="row">
                  <div class="col-25">
      ...
      <?php
         ...
         header("refresh:1; url=/ShuSeeYong/project/php/admin/loginad.php");
      ?>
      <?php
         }else{
           echo 'no result';
