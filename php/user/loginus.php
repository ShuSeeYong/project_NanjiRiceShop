<?php
   ...
   if (isset($_POST['submit'])) {
       ...
       if ($select_stmt->rowCount() > 0) {
           ...
           echo "<script> window.location.replace('/ShuSeeYong/project/php/user/mainus.php')</script>";
       } else {
           session_unset();
           session_destroy();
...
<html>
   ...
   <body onload="loadCookies()">
      ...
      <div class="navbar">
         <a href="/ShuSeeYong/project/html/register.html" class="right">Register</a>
      ...
      <div class="main">
         ...
         <div class="container">
            <form name="loginForm" action="../user/loginus.php" onsubmit="return validateLoginForm()" method="post">
               <div class="row">
                  <div class="col-25">
               ...
               <div class="row">
                  <div class="forget">
                     <a style="text-decoration:none;color:black;font-weight: bold;" href="/ShuSeeYong/project/php/user/forget.php">Forgot password?</a>
                  </div>
               </div>
               <br>
               <div class="row">
