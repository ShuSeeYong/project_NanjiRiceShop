   ...
   <body>
      ...
      <div class="main">
         ...
         <div class="container">
            ...
            ?>
            <form name="profileForm" action="../user/profile.php" onsubmit="return validateProForm()" method="post">
               <div class="row">
                  <div class="col-25">
...
<?php
   if(isset($_POST['submit'])){
     ...
     $phone = $_POST['phone'];
     $email = $_POST['email'];
      $query = "UPDATE tbl_user SET name = '$name',
                                    phone = '$phone'
                                    WHERE email = '$email'";
      $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
?>
<script type="text/javascript">alert("Update Successfull.");
   window.location = "mainus.php";
</script>
<?php
   }              
?>